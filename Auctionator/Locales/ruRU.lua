...
AtrL["Auction median"] = "Медиана аукциона"
...
AtrL["Rare"] = "Редкое"
AtrL["Search For"] = "Наименование"
AtrL["Subcategory"] = "Подкатегория"
AtrL["Level Range"] = "Диапазон уровней"
...
AtrL["Scan failed"] = "Скан не удался"
AtrL["Waiting for auction data"] = "Ожидание данных аукциона"
AtrL["Receiving data"] = "Получение данных"
AtrL["Slow scan (no cooldown)"] = "Медленный скан (без кулдауна)"
AtrL["Class scan (no cooldown)"] = "Скан по категориям (без кулдауна)"
AtrL["Full scan (no cooldown)"] = "Полный скан (без кулдауна)"
AtrL["Scanning %s (%d/%d) p.%d"] = "Скан %s (%d/%d) стр.%d"
AtrL["Scanning %s / %s (%d/%d) p.%d"] = "Скан %s / %s (%d/%d) стр.%d"
AtrL["SCAN_INTRO"] = "Сканирование создаёт базу цен для подсказок на предметах и рекомендаций при выставлении лотов на аукцион."
AtrL["GetAll warning"] = "GetAll: ~55 000 лотов, максимум уник. предметов из этого пакета (~15 сек, кулдаун 15 мин)."
AtrL["SCAN_HELP_GETALL"] = "GetAll — быстрый скан (~55 000 лотов, ~15 сек). Кулдаун Blizzard — 15 минут. В базу попадают уникальные названия предметов из полученного пакета (не каждый лот). Если сервер не отдал данные — подождите и попробуйте снова. На слабом соединении возможен разрыв."
AtrL["SCAN_HELP_FULL"] = "Полный скан — все категории аукциона (~15–20 мин), без кулдауна GetAll. Снимите галочку GetAll для этого режима."
AtrL["Cancel scan"] = "Отмена"
AtrL["Scan cancelled"] = "Сканирование отменено"
AtrL["Scan complete status"] = "Скан завершён (%s)"
AtrL["GetAll waiting cooldown"] = "GetAll на кулдауне — ожидание. «Отмена» прервёт ожидание."
AtrL["GetAll cooldown ready"] = "Кулдаун GetAll прошёл — запуск сканирования..."
AtrL["GetAll cooldown status"] = "Ожидание GetAll"
AtrL["waiting for server"] = "ожидание сервера..."
AtrL["checking server"] = "проверка сервера..."
AtrL["in %d sec"] = "через %d сек"
AtrL["GetAll on cooldown try later"] = "GetAll ещё на кулдауне. Попробуйте позже (обычно через 15 мин)."
AtrL["GetAll no server data"] = "Сервер не отдал данные. Подождите ~15 мин и попробуйте снова."
AtrL["GetAll no server data chat"] = "GetAll: сервер не ответил. Подождите кулдаун (~15 мин) и повторите."
AtrL["Scan wait server"] = "Сервер занят. Подождите несколько секунд."
AtrL["Processing retry"] = "Повторная обработка"
AtrL["GetAll AH total"] = "Всего на аукционе"
AtrL["GetAll batch cap"] = "Получено GetAll"
AtrL["GetAll names recovered"] = "Имён восстановлено по ссылке"
AtrL["GetAll names missing"] = "Имён не удалось прочитать"
AtrL["GetAll fast scan (15 min CD)"] = "GetAll — быстрый скан (кулдаун 15 мин)"
AtrL["GetAll fast scan"] = "GetAll — быстрый скан"
AtrL["GetAll cooldown hint"] = "(кулдаун 15 мин)"
AtrL["unique items"] = "уник. предметов"
AtrL["GetAll on cooldown"] = "GetAll на перезарядке (~15 мин). Подождите или снимите галочку GetAll."
AtrL["GetAll preflight many fails"] = "Много неудачных GetAll. Сейчас высокий риск дисконекта."
AtrL["GetAll preflight risky"] = "GetAll нестабилен по статистике. Рекомендуется скан без галочки."
AtrL["GetAll preflight peak hours"] = "Пиковые часы — аукцион перегружен, GetAll может отвалиться."
AtrL["GetAll blocked disconnect"] = "GetAll заблокирован: на этом сервере он рвёт соединение при приёме ~55k лотов (AH ~144k). Используйте скан БЕЗ галочки — без кулдауна, ~17 мин."
AtrL["GetAll blocked many fails"] = "GetAll заблокирован после нескольких обрывов. Используйте скан без галочки или /atr scandiag clear для сброса."
