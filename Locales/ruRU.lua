...
AtrL["You may have at most 40 single-stack (x1)\nauctions posted for this item.\n\nYou already have %d such auctions and\nyou are trying to post %d more."] = "Вы можете иметь не более 40 однорядных (x1) аукционов для этого предмета.\n\nУ вас уже есть %d таких аукционов, и вы пытаетесь выставить ещё %d.";
